...
<body>
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl  container">
        ...
        <p class=" my-2 md:text-xl text-left px-48 md:px-60">
            <strong>Benefit plans and options are always changing,</strong> so <br> speak to our licensed sales agents and choose the rigth
            <br>Medicare Advantage plan before enrollment ends!
        </p>
